...
<div class="flex" style="margin-bottom:.9rem;">
  <div class="card stat-card"><h3>Paid Online</h3><p class="big-num"><?= number_format($aggRow['online_total']??0,2) ?></p></div>
  <div class="card stat-card"><h3>Paid Cash</h3><p class="big-num"><?= number_format($aggRow['cash_total']??0,2) ?></p></div>
  <div class="card stat-card"><h3>Pending Amount</h3><p class="big-num"><?= number_format($aggRow['pending_total']??0,2) ?></p><small><?= (int)$aggRow['pending_count'] ?> pending</small></div>
</div>
<table class="table">
  <tr><th>ID</th><th>Req</th><th>Customer</th><th>Technician</th><th>Amount</th><th>Method</th><th>Status</th><th>Confirmed</th><th>Paid At</th></tr>
