...
<p><a class="btn" href="request_new.php">New Request</a> <a class="btn outline" href="my_requests.php">All Requests</a></p>
...
<tr><td><?= $row['request_id'] ?></td><td><?= htmlspecialchars($row['device_type']) ?></td><td><?= htmlspecialchars($label) ?></td><td><?= $row['updated_at'] ?></td></tr>
<?php endwhile; ?>
</table>
