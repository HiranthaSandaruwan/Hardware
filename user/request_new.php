...
<form method="post" data-validate>
  <label>Device Type
    <input name="device_type" required value="<?= htmlspecialchars($_POST['device_type'] ?? '') ?>">
  </label>
  <label>Model
    <input name="model" value="<?= htmlspecialchars($_POST['model'] ?? '') ?>">
  </label>
  <label>Serial No
    <input name="serial_no" value="<?= htmlspecialchars($_POST['serial_no'] ?? '') ?>">
  </label>
  <label>Category
